...
// TODO: We were enabling this on Android. TBD if there are user scenarios that require manual cert management.
// If nothing shows up in the next few months it can be removed.
